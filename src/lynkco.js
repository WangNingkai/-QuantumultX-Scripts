...
获取方式：打开  领克 app 【官方版】-> 添加小组件-> 等待获取车辆数据
===================
[MITM]
hostname = device-api.xchanger.cn

【Surge脚本配置】:
===================
[Script]
领克数据 = type=http-response,pattern=https:\/\/device-api\.xchanger\.cn,requires-body=1,max-size=0,script-path=https://gitee.com/wangningkai/QuantumultX-Script/raw/main/src/lynkco.js,script-update-interval=0

===================
【Loon脚本配置】:
===================
[Script]
http-response https:\/\/device-api\.xchanger\.cn tag=领克数据, script-path=https://gitee.com/wangningkai/QuantumultX-Script/raw/main/src/lynkco.js
...
const APIKey = 'lynkco_data';
$ = new API(APIKey, true);
if ($request) GetVehicleStatus();
